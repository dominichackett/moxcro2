      ...
      >
        <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className={`max-w-sm w-full ${props.type == 1 ?  "bg-green-500": "bg-red-500"} shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden`}>
              <div className="p-4">
