...
contract Marketplace is Ownable, ReentrancyGuard{
    ...
    event TokenListed(address contractAddress, address seller, uint256 tokenId, uint256 amount, uint256 pricePerToken,uint256 listingId);
    event TokenSold(address contractAddress, address seller, address buyer, uint256 tokenId, uint256 amount, uint256 pricePerToken,uint256 listingId);
    ...
    function listToken(address contractAddress, uint256 tokenId, uint256 amount, uint256 price) public nonReentrant {
        ...
        emit TokenListed(contractAddress, msg.sender, tokenId, amount, price,listingId);
    }
